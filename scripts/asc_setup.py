...
record, and the App Privacy label.
    ...
    bundle-id   register the explicit App ID com.danheskett.openpairs
...
APP_NAME = "openpairs"
PROFILE_NAME = "Openpairs App Store"
PRIVACY_URL = "https://danheskett.com/app/privacy-policy/"
SUPPORT_URL = "https://danheskett.com"
MARKETING_URL = "https://danheskett.com/projects/openpairs/"

# ios/app-store-assets/LISTING.md: Games -> Family, with Puzzle as the second
# games subcategory.
PRIMARY_CATEGORY = "GAMES"
SUBCATEGORIES = ("GAMES_FAMILY", "GAMES_PUZZLE")
