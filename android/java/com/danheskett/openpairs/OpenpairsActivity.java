package com.danheskett.openpairs;
 ...
 */
public class OpenpairsActivity extends NativeActivity {

    // NativeActivity loads libopenpairs.so by dlopen()ing it in framework
