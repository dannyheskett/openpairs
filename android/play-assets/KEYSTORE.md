...
keytool -genkeypair -v \
  -keystore openpairs-upload.jks \
  -alias openpairs-upload \
  -keyalg RSA -keysize 2048 -validity 10000 \
  -dname "CN=Danny Heskett, O=openpairs, C=US"
```

It prompts for a **keystore password** and a **key password** — pick strong
ones and save them in your password manager. Keep `openpairs-upload.jks`
...
```sh
base64 -w0 openpairs-upload.jks > upload.jks.b64
gh secret set PLAY_UPLOAD_KEYSTORE   < upload.jks.b64
gh secret set PLAY_KEY_ALIAS         -b "openpairs-upload"
...
secret and produce `openpairs-<version>-android.aab` alongside the sideload
