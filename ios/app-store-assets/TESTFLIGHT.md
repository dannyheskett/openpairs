# Getting openpairs into TestFlight
...
Throughout: bundle ID is `com.danheskett.openpairs`, and it must match
...
per-app and must be done for openpairs.
...
- Type: **App IDs** → **App**
- Description: `openpairs`
- Bundle ID: **Explicit** → `com.danheskett.openpairs`
...
- App ID: `com.danheskett.openpairs`
...
| --- | --- |
| Platform | iOS |
| Name | `openpairs` (see [LISTING.md](LISTING.md) for fallbacks if taken) |
