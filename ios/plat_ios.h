#ifndef OPENPAIRS_PLAT_IOS_H
#define OPENPAIRS_PLAT_IOS_H

#include "op_types.h" // Vector2, bool

// State pushed from the UIKit view (ios_main.mm) into the C-facing queries the
// game reads through op_types.h (GetScreenWidth / GetTouchPosition / …). All
